  ...
  return (
    <div className={`fixed-links-wrapper fixed-links-${props.fixedlinksvisibility}`}>
      <ul className="fixed-links">
        <li>
          <a href="https://www.linkedin.com/in/juliusgdorfman/" target="_blank" rel="noopener noreferrer">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="white" stoke-width="1px" viewBox="0 0 24 24"><title>LinkedIn</title><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path>
        ...
        <li>
          ...
          <a href="https://github.com/JuliusDorfman/" target="_blank" rel="noopener noreferrer">
        ...
        <li>
          ...
          <a href="https://codepen.io/juliusdorfman" target="_blank" rel="noopener noreferrer">
            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="white" strokeWidth="1">
