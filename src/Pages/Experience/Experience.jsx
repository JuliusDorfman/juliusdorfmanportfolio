      ...
      <section id="experience-component">
        ...
        <div className="experience-section">
          <div className="accordian">
            ...
            <div className={`accordian-content content-${contentActive.firstItem}`}>
            ...
            <div className={`accordian-content content-${contentActive.secondItem}`}>
                <div className="accordian-details">
                  <div className="company-info">
                    <span>
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
            ...
            <div className={`accordian-content content-${contentActive.thirdItem}`}>
                <div className="accordian-details">
                  <div className="company-info">
                    <span>
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
