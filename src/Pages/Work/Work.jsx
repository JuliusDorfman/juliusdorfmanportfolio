              ...
              <li>
                <div className="other-project-inner">
                  <header>
                    ...
                    <h3 className="other-project-title">News-From</h3>
                    <div className="other-project-description">A data visualization application.
                      <br />
                      <br />
                      See what U.S. News is talking about in real time. Draw your own conclusions based on
                      headline vernacular and frequency of keyword appearence.
                    </div>
                  </header>
                  <footer>
                    <ul className="other-project-links">
                      <li>ReactJS</li>
                      <li>Nodejs</li>
                      <li>Mongoose</li>
                      <li>
                        <a href="https://github.com/JuliusDorfman/news-from" target="_blank" rel="noopener noreferrer">
                          <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="white" strokeWidth="1">
                            <path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path>
                          </svg>
                        </a>
                      </li>
                      <li><a href="https://news-from.herokuapp.com/"
              ...
              <li>
                <div className="other-project-inner">
                  <header>
                    ...
                    <h3 className="other-project-title">WIP: <br />SummarizeMe</h3>
                    <div className="other-project-description">
