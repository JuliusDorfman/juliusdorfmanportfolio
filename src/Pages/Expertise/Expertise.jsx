    ...
    return (
      <section id="expertise-component">
        ...
        <div className="expertise-content-wrapper">
          ...
          <div data-aos="fade-up" className="frontend-development">
            ...
            <h3>Passionate about UI/UX. Over {yearsPassed} years of development experience in HTML, CSS, JS, and React frameworks.</h3>
          </div>

          <div data-aos="fade-up" data-aos-duration="2500" className="software-development">
            ...
            <h3>Experienced in both functional and OOP: RPG&#40;LE&#41;, Python, JavaScript, TypeScript.</h3>
          </div>
